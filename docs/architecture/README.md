...
| [RTC_SCALE_AND_CLIENT_OFFLOAD.md](./RTC_SCALE_AND_CLIENT_OFFLOAD.md) | 客户端减载、SFU/TURN 容量、stage + audience 和规模任务 |
...
涉及多人并发、万人观看或客户端分摊时，继续阅读 [ADR-005](../adr/ADR-005-CLIENT-OFFLOAD-AND-SCALE.md)，并按 RTC-011～RTC-015 的依赖顺序推进。
